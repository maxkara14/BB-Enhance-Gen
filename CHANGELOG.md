...
### 1.5.0 — 14 сентября 2026 (enhance-test)
...
- Сохранён мобильный CSS-фикс версии 1.4.9. Версия 1.5.0 пока доступна только в тестовой ветке `enhance-test`.
...
### 1.5.0 — September 14, 2026 (enhance-test)
...
- Includes the mobile CSS fix from 1.4.9. Version 1.5.0 is currently available only on the `enhance-test` branch.
